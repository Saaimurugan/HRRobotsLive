...
const Header = () => {
  ...
  const authPages = ["/login", "/logout", "/signup", "/forgot-password", "/verify-email", "/signup-success"];
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", paddingRight: "15px", gap: "5px" }}>
        {isResult ? (
          <>
            {!isLogin && (
              <button style={navButtonStyle} onClick={() => navigate("/list")}>
          ...
          <>
            ...
            >
              <button style={navButtonStyle} onClick={() => navigate("/profile")}>
                <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button style={navButtonStyle} onClick={() => navigate("/logout")}>
              <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
