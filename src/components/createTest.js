  ...
  return (
    <div className="app">
      ...
      <div className="container" style={{ marginTop: "45pt" }}>
        ...
        <div className="card" data-tour="agentic-hr">
          <div className="card-icon">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <circle cx="17" cy="9.5" r="1" fill="white"/>
            </svg>
          </div>
          <h2>Agentic HR</h2>
          <p>Automated end-to-end hiring: Collect profiles from LinkedIn, Naukri & Monster, profile candidates, generate tests, send invites & follow-ups, and view top 25 matches.</p>
          <div className="form-group">
            <button onClick={() => navigate("/agenticHR")}>Start Agentic Process</button>
          </div>
        </div>	
