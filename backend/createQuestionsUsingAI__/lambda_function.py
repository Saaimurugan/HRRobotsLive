...
Do NOT paraphrase or modify the text - copy it character-by-character and correctAnswer is mandatory.
...
4. Do not add Option A:...Option D: to the begining of the Options and correctAnswer"""
